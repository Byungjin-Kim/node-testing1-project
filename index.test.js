...
describe('[Exercise 3] findLargestInteger', () => {
  test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    ...
    const input3 = [{ integer: 1 }, { integer: 3 }, { integer: 5 }]
...
describe('[Exercise 4] Counter', () => {
  ...
  test('[8] the count eventually reaches zero but does not go below zero', () => {
    counter.countDown();
    counter.countDown();
    counter.countDown(); // thirdCount
    counter.countDown(); // fourthCount
...
describe('[Exercise 5] Seasons', () => {
  ...
  test('[10] the SECOND call of seasons.next returns "fall"', () => {
    seasons.next(); // Call seasons.next() once to move to the next season
  ...
  test('[12] the FOURTH call of seasons.next returns "spring"', () => {
    seasons.next(); // Call seasons.next() three times to move to the next season - "spring"
    seasons.next();
    seasons.next();
  ...
  test('[13] the FIFTH call of seasons.next returns again "summer"', () => {
    seasons.next(); // Call seasons.next() four times to move to the next season - "summer"
    seasons.next();
    seasons.next();
    seasons.next();
    const result = seasons.next();
